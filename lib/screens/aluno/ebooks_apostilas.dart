                  ...
                  Padding(padding: EdgeInsets.all(10.0), child: 
                    Center(child: 
                      Row(children: <Widget>[
                        ...
                        Text("E-books & Apostilas", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 22)),
                      ]),
                    ),
                  ),
                  SizedBox(height: 20.0),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        FlatButton.icon(
                          ...
                          label: Text('Baixar apostila', style: TextStyle(color: Colors.white, fontSize: 20.0)),
