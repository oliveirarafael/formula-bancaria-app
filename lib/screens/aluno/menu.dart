          ...
          child: Column(children: <Widget>[
            Column(children: <Widget>[
              ...
              Container(
                ...
                child: Row(children: <Widget>[
                  Container(child: Image.asset('assets/icons/percent.png', height: 60,)),
                  SizedBox(width: 5.0,),
                  ...
                  SizedBox(width: 5.0,),
                  Container(child: Image.asset('assets/icons/cart.png', height: 60,)),
                  SizedBox(width: 5.0,),
                  Container(child: Image.asset('assets/icons/play.png', height: 60,)),
                ]),
              ),
            ]),
          ])
